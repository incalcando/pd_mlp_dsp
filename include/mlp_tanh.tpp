...
MLP_TANH<IN_SIZE, H1_SIZE, H2_SIZE, H3_SIZE, OUT_SIZE>::MLP_TANH(size_t epochs) : 
...
template <size_t IN_SIZE, size_t H1_SIZE, size_t H2_SIZE, size_t H3_SIZE, size_t OUT_SIZE>
idsp::c_vector<double, OUT_SIZE> MLP_TANH<IN_SIZE, H1_SIZE, H2_SIZE, H3_SIZE, OUT_SIZE>::forward(const idsp::c_vector<double, IN_SIZE>& current_input, bool linear_output) {
...
template <size_t IN_SIZE, size_t H1_SIZE, size_t H2_SIZE, size_t H3_SIZE, size_t OUT_SIZE>
void MLP_TANH<IN_SIZE, H1_SIZE, H2_SIZE, H3_SIZE, OUT_SIZE>::train(
...
template <size_t IN_SIZE, size_t H1_SIZE, size_t H2_SIZE, size_t H3_SIZE, size_t OUT_SIZE>
idsp::c_vector<double, OUT_SIZE> MLP_TANH<IN_SIZE, H1_SIZE, H2_SIZE, H3_SIZE, OUT_SIZE>::generate_output() {
...
template <size_t IN_SIZE, size_t H1_SIZE, size_t H2_SIZE, size_t H3_SIZE, size_t OUT_SIZE>
void MLP_TANH<IN_SIZE, H1_SIZE, H2_SIZE, H3_SIZE, OUT_SIZE>::clear_data() {
...
template <size_t IN_SIZE, size_t H1_SIZE, size_t H2_SIZE, size_t H3_SIZE, size_t OUT_SIZE>
void MLP_TANH<IN_SIZE, H1_SIZE, H2_SIZE, H3_SIZE, OUT_SIZE>::accumulate_data(const idsp::c_vector<double, IN_SIZE>& inputs, const idsp::c_vector<double, OUT_SIZE>& targets) {
...
template <size_t IN_SIZE, size_t H1_SIZE, size_t H2_SIZE, size_t H3_SIZE, size_t OUT_SIZE>
void MLP_TANH<IN_SIZE, H1_SIZE, H2_SIZE, H3_SIZE, OUT_SIZE>::retrain(double learning_rate, int epochs) {
...
template <size_t IN_SIZE, size_t H1_SIZE, size_t H2_SIZE, size_t H3_SIZE, size_t OUT_SIZE>
void MLP_TANH<IN_SIZE, H1_SIZE, H2_SIZE, H3_SIZE, OUT_SIZE>::initialize_weights_and_biases() {
...
template <size_t IN_SIZE, size_t H1_SIZE, size_t H2_SIZE, size_t H3_SIZE, size_t OUT_SIZE>
idsp::c_vector<double, IN_SIZE> MLP_TANH<IN_SIZE, H1_SIZE, H2_SIZE, H3_SIZE, OUT_SIZE>::find_closest_data_set(const idsp::c_vector<double, OUT_SIZE>& target) {
